...
extern const Info<std::string> GFX_TEXTURE_PACK;
extern const Info<std::string> GFX_TEXTURE_PACKS_ACTIVE;
extern const Info<std::string> GFX_TEXTURE_PACKS_BASEBALL;
extern const Info<std::string> GFX_TEXTURE_PACKS_GOLF;
